...
--
-- Máy chủ: 127.0.0.1
-- Thời gian đã tạo: Th3 30, 2024 lúc 06:30 AM
...
(21, 76, 'Hhiihihi', '2024-03-30', 2),
(22, 76, 'bcjabcja', '2024-03-30', 4);
...
INSERT INTO `chi_tiet_don_hang` (`maDonHang`, `maSanPham`, `soLuong`) VALUES
(7, 2, 5);
...
INSERT INTO `chi_tiet_gio_hang` (`maGioHang`, `maSanPham`, `soLuong`) VALUES
(3, 2, 1);
...
INSERT INTO `don_hang` (`maDonHang`, `ngayDat`, `tongGiaTri`, `trangThai`, `maKhachHang`, `diaChi`, `soDienThoai`, `tienTrinh`) VALUES
(7, '2024-03-30', '1995000.00', 'Chưa thanh toán', 18, 'MeLinh - HaNoi', '0961388214', 'Đang giao hàng');
...
(17, 'Lambautroi', 'Nam', '2004-05-24', 'Hanoi', 73),
(18, 'Lâm Bầu Trời', 'Nam', '2004-05-24', 'MeLinh - HaNoi', 76);
...
(73, 'lamnqhph46027@fpt.edu.vn', 'test', 'vvvvvv', b'0', 'users/11d9cd95fde924b77df8.jpg'),
(75, 'admin@admin.com', 'admin', '123456', b'1', 'users/user-default.png'),
(76, 'chinh.nncn@gmail.com', 'Lamnamday', '123456', b'0', 'users/20221101_183521-01.png');
...
--
ALTER TABLE `tai_khoan`
  MODIFY `maTaiKhoan` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=77;
